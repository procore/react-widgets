...
var Multiselect = _react2['default'].createClass(babelHelpers.createDecoratedObject([{
  ...
  value: function render() {
    ...
    var classIconParent = _classnames2['default']({ "invisible": !busy });
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { className: _classnames2['default']({ invisible: !shouldRenderTags }) },
          _react2['default'].createElement(_MultiselectTagList2['default'], babelHelpers._extends({}, tagsProps, {
            ...
            valueComponent: _react2['default'].createElement(
              'p',
              null,
              'heheh'
            ),
