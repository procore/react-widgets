...
var Multiselect = _react2['default'].createClass(babelHelpers.createDecoratedObject([{
  ...
  value: function render() {
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'div',
        { style: { backgroundColor: 'red' }, className: 'rw-multiselect-wrapper', ref: 'wrapper' },
        _react2['default'].createElement('i', { className: _classnames2['default']("rw-i rw-loading", { "hidden": !!busy }) }),
